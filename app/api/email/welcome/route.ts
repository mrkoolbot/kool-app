...
export async function POST(request: Request) {
  ...
  const manualBlock = isPaid ? `
      <div style="background:#f8f8f8;border-left:3px solid #D90000;padding:20px;margin:24px 0;">
        ...
        <p style="color:#555;font-size:13px;margin:0;line-height:1.6;">25 chapters written by paula mescolin — covering everything from formal table settings to multicultural hospitality. yours, as part of your ${plan} membership.</p>
      </div>
...
<body style="margin:0;padding:0;background:#f5f5f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:560px;margin:40px auto;background:#ffffff;">
    <div style="background:#0a0a0a;padding:32px 40px;text-align:left;">
      <img src="https://koolevents.app/kool-logo-white.png" alt="kool events" width="140" style="display:block;border:0;" onerror="this.style.display='none'" />
      <table role="presentation" style="display:none;" class="fallback-logo">
        <tr><td style="font-family:Arial Black,Arial,sans-serif;font-size:34px;font-weight:900;color:#ffffff;letter-spacing:-1px;">kool<span style="color:#D90000;">&#9829;</span></td></tr>
        <tr><td style="font-family:Arial,sans-serif;font-size:10px;color:#ffffff;letter-spacing:7px;">events</td></tr>
      </table>
    </div>
    ...
    <div style="border-top:1px solid #eee;padding:20px 40px;text-align:center;">
      <p style="color:#999;font-size:12px;margin:0;">intellectual property of <a href="https://koolevents.app" style="color:#D90000;text-decoration:none;">the koolture group (TKG)</a> · all rights reserved</p>
    </div>
  </div>
</body>
</html>`;
