        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "2rem" }}>
          <div style={{ position: "relative", display: "inline-block" }}>
            <div style={{
              ...
              border: "3px solid #eb1e00", outline: "4px solid transparent",
              boxShadow: "0 0 0 6px rgba(235,30,0,0.2)",
              animation: "floatUp 4s ease-in-out infinite",
            }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/paula-avatar-3d.jpg" alt="Paula Mescolin" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "top" }} />
            </div>
          </div>
          <div style={{
            ...
            <p style={{ fontSize: 11, color: "#eb1e00", fontWeight: 700, marginTop: 4 }}>— paula mescolin, founder tkG</p>
          </div>
        </div>
        <style>{`
          @keyframes floatUp {
